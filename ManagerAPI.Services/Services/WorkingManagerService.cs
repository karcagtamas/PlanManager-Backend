...
namespace ManagerAPI.Services.Services
{
    ...
    public class WorkingManagerService : IWorkingManagerService
    {
        ...
        public void AddWorkingField(int workingDayId, WorkingFieldModel model)
        {
            User user = this._utilsService.GetCurrentUser();
        ...
        public void UpdateWorkingField(int workingFieldId, WorkingFieldModel model)
        {
            User user = this._utilsService.GetCurrentUser();
        ...
        public WorkingDayStatDto GetWorkingDayStat(int id)
        {
            var user = this._utilsService.GetCurrentUser();
            var workingDay = _context.WorkingDays.Find(id);
            ...
            this._loggerService.LogInformation(user, nameof(WorkingManagerService), "get working day stat", workingDay.Id);

            return this._mapper.Map<WorkingDayStatDto>(workingDay);
        }
    }
}
